...
<html lang="en" dir="ltr">
  <head>
	...
	<style>@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@300&display=swap');</style>
  </head>
	<body>
       <header class="item-header">
          <article class="item-logo"> <a href="Homepage.php"><img src="images/Gietje2.0kaas.png" alt="Logo" height="80px"; width="80px";></a></article>
        <nav class="item-navbar">
            <ul>                    
                       <li><a href="Producten.html">Producten</a></li>
                       <li><a href="Aanbiedingen.html">Aanbieding</a></li>
                       <li><a href="evenementdetails.php">Artiesten</a></li>
  ...
  <body>
            ...
            <img class="item-foto" src="images/<?php echo $row[5];?>.jpg" alt="afbeelding van het evenement" height="600px";>
